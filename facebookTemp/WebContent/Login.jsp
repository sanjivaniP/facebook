...
.alert-box {
	...
	font-size: 18px;
	background: #ffecec url('Images/error.png') no-repeat 40px 50%;
}
...
function WriteCookie()
{
	...
	document.cookie="name=" + cookievalue; //for same browser
	if(document.loginForm.keepMeLoggedIn.checked){
	
   
   document.cookie="name=" + cookievalue+"; max-age="+60*60*24*30; //for keep me logged in
...
if( document.signUpForm.genderFemale.checked== false&& document.signUpForm.genderMale.checked==false)
{
...
<body
	...
	<div
		style="position: absolute; width: 100%; height: 100px; background-color: #3b5998; left: 0px">
		<form action="login" name="loginForm" method="post"
			onsubmit="WriteCookie();">
			<br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
			&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <font color="white"
				size="7"><b> facebook </b></font>
	</div>
	<div
		style="position: absolute; width: 750px; height: 100px; background-color: #3b5998; left: 730px">
		...
		<input type="password" name="password" size="18">&nbsp; <input
			type="submit" value="Log in" onclick="writeCookie();"><br>
		...
		<s:if test="hasActionErrors()">
			<div
				style="left: -700px; position: relative; width: 930px; top: -2px; color: #555; background: #ffecec">
				<s:actionerror />
			</div>
		</s:if>
	</div>
	...
	<div id="content"
		style="position: relative; background-color: #eeeff4; height: 1000px; width: 1500px; left: 700px; top: 120px">
		<h1>
		...
		<form action="signUp" name="signUpForm"
			...
			<br> <br> <input type="text" name="fname"
				placeholder="First Name" size="22" style="height: 39px"
				value="<s:property value="fname"/>"> <input type="text"
				name="lname" placeholder="Last Name" size="21" style="height: 39px"
				value="<s:property value="lname"/>"><br> <br> <input
				type="text" name="email" id="email" placeholder="Your email address"
				size="50" style="height: 39px" value="<s:property value="email"/>"><br>
			<br> <input type="text" name="reEnteredEmail"
				id="reEnteredEmail" onkeyup='matchEmail();'
				value="<s:property value="reEnteredEmail"/>"
			...
			<br> <label for="birthday">Birthday</label> <br> <br>
			<select name="day">
			...
			</select> <br> <br> <input type="radio" name="genderFemale"
				id="female" value="female"> <label for="female">Female</label>
			<input type="radio" name="genderMale" id="male" value="male">
			<label for="male">Male</label> <br> <br> <input
				type="image" src="Images/b1.png" alt="Create an account" width="260"
				height="65"><br>
		</form>
	</div>
