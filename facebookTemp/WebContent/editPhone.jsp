...
/* function validateNumber()
{
	...
	if(isNAN(number+String.fromCharCode(event.keyCode))|| number.length>9)
		{
		return false;
		}
	return true;
...
<h3>Edit Phone Number</h3>
 ...
 <INPUT TYPE="text" NAME="phoneNumber" id="number"  required="required"  value="<s:property value="phoneNumber1"/>" />
  <br/>
