                      	 ...
                      	 <div class=" navbar navbar-default navbar-collapse collapse" id="profile-nav">
          						<ul class="nav navbar-nav">
          							<li><a href="#about" style="color: rgb(102, 102, 102); padding: 10px 10px 11px; font-size: 14px; width:250px;" ></a></li>
          							  ...
          							  <li><a href="#" style="color: rgb(102, 102, 102); padding: 10px 10px 11px; font-size: 14px;" >Photos</a></li>
                         ...
                         <table class="table table-bordered" border="2">
							...
							<tr>
								...
								<td rowspan="3" width="700px">
									<tiles:insertAttribute name="workandEducation" />
								</td>
							...
							<tr>
								<td><tiles:insertAttribute name="contact" /></td>
							</tr>
