                      	 ...
                      	 <div class=" navbar navbar-default navbar-collapse collapse" id="profile-nav">
          						<ul class="nav navbar-nav">
          							<li><a href="#about" style="color: rgb(102, 102, 102); padding: 10px 10px 11px; font-size: 14px; width:250px;" ></a></li>
          							  ...
          							  <li><a href="<s:url action='viewPhotosTemp'><s:param name="profileId"><s:property value="profileId"/></s:param></s:url>" style="color: rgb(102, 102, 102); padding: 10px 10px 11px; font-size: 14px;" >Photos</a></li>
