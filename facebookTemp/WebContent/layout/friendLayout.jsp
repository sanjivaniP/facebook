              ...
              <!--profile nav and cover  -->
				<div class="row" style="width:100%;height:400px">
                      	 ...
                      	 <div class=" navbar navbar-default navbar-collapse collapse" id="profile-nav">
          						<ul class="nav navbar-nav">
          							<li><a href="#about" style="color: rgb(102, 102, 102); padding: 10px 10px 11px; font-size: 14px; width:250px;" ></a></li>
           							 <li><a href="<s:url action='profileTempAction'/>"  style="color: rgb(102, 102, 102); padding: 10px 10px 11px; font-size: 14px;" >Timeline</a></li>
           							 <li><a href="<s:url action='About'/>" style="color: rgb(102, 102, 102); padding: 10px 10px 11px; font-size: 14px;" >About</a></li>
          							  <li><a href="<s:url action='viewPhotosTemp'/>" style="color: rgb(102, 102, 102); padding: 10px 10px 11px; font-size: 14px;" >Photos</a></li>
          							  <li><a href="<s:url action='getFriends'/>" style="color: rgb(102, 102, 102); padding: 10px 10px 11px; font-size: 14px;" >Friends</a></li>
          							  <!-- <li><a href="fanclub.jsp"
										style="color: rgb(102, 102, 102); padding: 10px 10px 11px; font-size: 14px;">Fan Club</a></li>
								 -->
          						</ul>
                    ...
                    <div class="full col-sm-11">
                       ...
                       <tiles:insertAttribute name="viewFriends" />
                        	</div>
                </div><!-- /col 12 -->
            </div>
            <!-- /main -->
